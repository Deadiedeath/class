...
pageContext.setAttribute("nullStr", null); //null
pageContext.setAttribute("emptyStr", ""); //빈문자열
pageContext.setAttribute("lengthZero", new Integer[0]); //길이가 0
pageContext.setAttribute("sizeZero", new ArrayList());  //사이즈가 0
%>    
<html>
<meta charset="UTF-8">
